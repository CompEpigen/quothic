...
# Example usage
#entropy <- shannon_entropy(obj, option="predefined")
entropy <- shannon_entropy(obj, option="RCSA")
...
# Example usage
#entropy <- shannon_entropy(pbmc3k.final, option="predefined")
entropy <- shannon_entropy(pbmc3k.final, option="RCSA")
